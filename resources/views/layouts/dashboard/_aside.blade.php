<aside class="main-sidebar">
    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu" data-widget="tree">
            ...
            <li><a href="#"> <i class="fa fa-book"></i><span>@lang('site.products')</span></a></li>
            <li><a href="#"> <i class="fa fa-book"></i><span>@lang('site.clients')</span></a></li>
            <li><a href="#"> <i class="fa fa-book"></i><span>@lang('site.orders')</span></a></li>
